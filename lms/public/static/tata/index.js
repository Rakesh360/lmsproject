! function (e) {
    ...
    function r(e) {
        ...
        r.type = "text/javascript", r.charset = "utf-8", r.src = f.p + "" + e + "." + w + ".hot-update.js", n.appendChild(r)
    }
    ...
    function o(e) {
        ...
        return r.e = function (e) {
            function n() {
                H--, "prepare" === k && (P[e] || l(e), 0 === H && 0 === x && u())
            }
            return "ready" === k && i("prepare"), H++, f.e(e).then(n, function (e) {
                throw n(), e
            })
        }, r
    }
    ...
    function a(e) {
        ...
        return b = e, i("check"), t(O).then(function (e) {
            ...
            m = {};
            return l(0), "prepare" === k && 0 === H && 0 === x && u(), n
        })
    }
    ...
    function p(r) {
        ...
        for (var v in m)
            if (Object.prototype.hasOwnProperty.call(m, v)) {
                        ...
                        if ((s = M[i]) && !s.hot._selfAccepted) {
                            ...
                            for (var a = 0; a < s.parents.length; a++) {
                                ...
                                if (u) {
                                    ...
                                    n.indexOf(l) >= 0 || (u.hot._acceptedDependencies[i] ? (r[l] || (r[l] = []), t(r[l], [i])) : (delete r[l], n.push(l), o.push({
                                        chain: d.concat([l]),
                                        id: l
                                    })))
                                }
                ...
                switch (b.chain && (x = "\nUpdate propagation: " + b.chain.join(" -> ")), b.type) {
                    case "self-declined":
                        r.onDeclined && r.onDeclined(b), r.ignoreDeclined || (O = new Error("Aborted because of self decline: " + b.moduleId + x));
                        break;
                    case "declined":
                        r.onDeclined && r.onDeclined(b), r.ignoreDeclined || (O = new Error("Aborted because of declined dependency: " + b.moduleId + " in " + b.parentId + x));
                        break;
                    case "unaccepted":
                        r.onUnaccepted && r.onUnaccepted(b), r.ignoreUnaccepted || (O = new Error("Aborted because " + l + " is not accepted" + x));
                        break;
                    case "accepted":
                ...
                if (E) {
                    h[l] = m[l], t(p, b.outdatedModules);
                    for (l in b.outdatedDependencies) Object.prototype.hasOwnProperty.call(b.outdatedDependencies, l) && (u[l] || (u[l] = []), t(u[l], b.outdatedDependencies[l]))
                }
                j && (t(p, [b.moduleId]), h[l] = y)
            } var H = [];
        for (c = 0; c < p.length; c++) l = p[c], M[l] && M[l].hot._selfAccepted && H.push({
            module: l,
            errorHandler: M[l].hot._selfAccepted
        });
        i("dispose"), Object.keys(I).forEach(function (e) {
            !1 === I[e] && n(e)
        });
        for (var P, A = p.slice(); A.length > 0;)
            if (l = A.pop(), s = M[l]) {
                var q = {},
                    C = s.hot._disposeHandlers;
                for (a = 0; a < C.length; a++)(o = C[a])(q);
                for (_[l] = q, s.hot.active = !1, delete M[l], delete u[l], a = 0; a < s.children.length; a++) {
                    var S = M[s.children[a]];
                    S && ((P = S.parents.indexOf(l)) >= 0 && S.parents.splice(P, 1))
                }
            } var U, L;
        for (l in u)
            if (Object.prototype.hasOwnProperty.call(u, l) && (s = M[l]))
                for (L = u[l], a = 0; a < L.length; a++) U = L[a], (P = s.children.indexOf(U)) >= 0 && s.children.splice(P, 1);
        i("apply"), w = g;
        ...
        for (l in u)
            if (Object.prototype.hasOwnProperty.call(u, l) && (s = M[l])) {
                ...
                for (c = 0; c < L.length; c++)
                    if (U = L[c], o = s.hot._acceptedDependencies[U]) {
                        if (B.indexOf(o) >= 0) continue;
                        B.push(o)
        ...
        return R ? (i("fail"), Promise.reject(R)) : (i("idle"), new Promise(function (e) {
            e(p)
        }))
    }
    ...
    f.m = e, f.c = M, f.d = function (e, n, r) {
        ...
        return w
    }, o("./src/index.js")(f.s = "./src/index.js")
}({
    "./src/index.js": function (e, n, r) {
        ...
        document.addEventListener("readystatechange", function () {
            if ("complete" === document.readyState) {
                var e = o(".loading"),
                    n = o(".btns");
                document.body.removeChild(e), n.addEventListener("click", function (e) {
                    var n = e.target,
                        r = n.dataset.type;
                    if (r) {
                        var a = o("#title").value,
                            s = o("#text").value,
                            l = [].concat(t(c("input[name=position]"))).find(function (e) {
                                return e.checked
                            }).value;
                        tata[r](a, s, {
                            duration: 1e3 * o("#duration").value,
                            position: l,
                            progress: o("input[name=progress]").checked,
                            holding: o("input[name=holding]").checked,
                            animate: o("input[name=animate]").checked ? "slide" : "fade",
                            closeBtn: o("input[name=closeBtn]").checked,
                            onClick: o("input[name=onClick]").checked ? i : null,
                            onClose: o("input[name=onClose]").checked ? d : null
                        })
                    }
                })
            }
