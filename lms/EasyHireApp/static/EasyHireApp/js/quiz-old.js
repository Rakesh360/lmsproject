...
function fetch_problem(response) {
    ...
    //problem_html += `<div id="problem-description" style="display:none;" >` + response["problem_description"] + `</div>`;
    problem_html += `<div id="problem-description" >` + response["problem_description"] + `</div>`;
    ...
    problem_html += `
              ...
              <div class="col s12">
                ...
                <!-- <a class="btn right modal-trigger" href="#modal-end-test">End Section</a> -->
              </div>
            </div>
        </div>
